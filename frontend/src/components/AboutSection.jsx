...
export default function AboutSection() {
  ...
  return (
    <section className="py-24 px-6 sm:px-12 lg:px-20 font-sans" style={{ backgroundColor: 'var(--color-cream)', color: 'var(--color-forest)', zIndex: 10, position: 'relative' }}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <motion.div variants={itemVariants} className="flex flex-wrap gap-4">
              ...
              <button className="px-8 py-4 rounded-full font-bold text-sm tracking-widest uppercase transition-transform hover:scale-105" style={{ backgroundColor: 'transparent', color: 'var(--color-forest)', border: '2px solid var(--color-forest)' }}>
                Contact Us
              </button>
            </motion.div>
          </motion.div>
